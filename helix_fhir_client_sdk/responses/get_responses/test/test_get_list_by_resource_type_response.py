...
class TestFhirGetListByResourceTypeResponse:
    ...
    def sample_resources(self) -> List[Dict[str, Any]]:
        ...
        return [
            ...
            {"resourceType": "Patient", "id": "789", "name": "Jane Smith"},
        ]
    ...
    def test_parse_resources(self, sample_resources: List[Dict[str, Any]]) -> None:
    ...
    def test_from_response(self, sample_resources: List[Dict[str, Any]]) -> None:
    ...
    def test_sort_resources(self, sample_resources: List[Dict[str, Any]]) -> None:
