...
class TestFhirDeleteMixin:
    ...
    @pytest.mark.asyncio
    async def test_delete_async_success(self, fhir_delete_mixin: FhirDeleteMixin) -> None:
    ...
    async def test_delete_async_no_id(self, fhir_delete_mixin: FhirDeleteMixin) -> None:
        ...
        with pytest.raises(ValueError, match="delete requires the ID of FHIR object to delete"):
            await fhir_delete_mixin.delete_async()

    @pytest.mark.asyncio
    async def test_delete_async_no_resource(self, fhir_delete_mixin: FhirDeleteMixin) -> None:
    ...
    @pytest.mark.asyncio
    async def test_delete_async_with_error(self, fhir_delete_mixin: FhirDeleteMixin) -> None:
    ...
    @pytest.mark.asyncio
    async def test_delete_by_query_async_success(self, fhir_delete_mixin: FhirDeleteMixin) -> None:
        ...
        with aioresponses() as m:
            ...
            response: FhirDeleteResponse = await fhir_delete_mixin.delete_by_query_async()
    ...
    @pytest.mark.asyncio
    async def test_delete_by_query_async_no_resource(self, fhir_delete_mixin: FhirDeleteMixin) -> None:
    ...
    @pytest.mark.asyncio
    async def test_delete_by_query_async_with_error(self, fhir_delete_mixin: FhirDeleteMixin) -> None:
